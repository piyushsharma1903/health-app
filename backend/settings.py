...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-b@2*)x%0!!0w%k-i_3dnb2b)2*j!9(0qb$t)ec7j$0-v0d$0=i')
...
print("✅ Loaded .env DB_NAME =", os.getenv("DB_NAME"))
...
# Add your deployment URLs to CSRF_TRUSTED_ORIGINS
